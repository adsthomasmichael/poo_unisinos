...
public class Principal {
    public static void main(String[] args){
        ...
        Hospital[] hospitales = {
                new HospitalPublico("HPU Cristo Redentor", "004.310.0005/51",100000, 130000, 20, 0013 ),
                new HospitalPublico("HPU Conceicao", "004.310.0005/51",700000, 700000, 24, 0014 ),
                new HospitalPublico("HPU Clínicas", "004.310.0005/51",400000, 150000, 18, 0015 ),
                new HospitalPrivado("HPR Mohamed X","004.310.0005/51", 1000000, 100000, 24, "Grupo Xmed" ),
                new HospitalPrivado("HPR Incor","004.310.0005/51", 70000, 1300000, 20, "Grupo Coramed" ),
                new HospitalPrivado("HPR Moinhos","004.310.0005/51", 200000, 230000, 24, "Moinhos Center" )
